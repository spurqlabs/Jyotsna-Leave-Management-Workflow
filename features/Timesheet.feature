Feature: Employee Timesheet Management
  ...
  Scenario Outline: Add time entries to timesheet for different projects
    ...
    Examples:
      ...
      | Apache Software Foundation - ASF - Phase 1   | Feature Development     | 8.00  | Monday    |
      | Internal - General HR Tasks                  | HR Audit                | 6.00  | Tuesday   |
  ...
  Scenario Outline: Edit existing timesheet entries
    ...
    Examples:
      ...
      | Apache Software       | 8.00      | 6.50      | Monday    |
      | Internal - Orangehrm  | 6.00      | 7.00      | Tuesday   |
      | Apache Software       | 7.50      | 8.00      | Wednesday |
